...
<p class="note">고속군일수록 분리각과 회전 속도가 계단식으로 커진다(모두 P&lt;0.0001). (출처: Myers et al. 2008, Table)</p>
 ...
 6:{"part":"PART 01 · 생체역학","title":"골프 워밍업과 부상·수행",
    ...
    "findings":[
      ...
      "5주 프로그램을 마친 <b>7주차에는 약 24.0%</b>(7~10 m/s)까지 누적 향상 — 꾸준히 할수록 효과가 커진다.",
 ...
 7:{"part":"PART 01 · 생체역학","title":"골프 스윙의 에너지·파워 분석 (모델링)",
    ...
    "findings":[
      "에너지 접근법으로 클럽을 가속시키는 <b>힘·토크 성분</b>과 각 신체 분절의 <b>에너지 생성 타이밍</b>을 새롭게 밝혔다.",
    ...
    "method":"두 컴퓨터 모델 사용 — (1) 클럽 상세 모델로 내부 에너지 전달, (2) 전신 모델로 관절 내부 에너지(역학적 일, work) 산출. 운동에너지·변형에너지·파워를 표준 역학으로 계산.",
    "significance":"실험으로 못 보는 내부 에너지 전달을 계산으로 열어, 장비·기술 최적화 연구의 토대가 됐다.",
...
<p class="note">연구 착수 1963년 가을 → 1968년 10월 출간. 참여 과학자 분야: 물리·탄도학·해부학·인체 생체역학·인간공학·사이버네틱스. (공동 연구 총괄: Alastair Cochran)</p>
 ...
 13:{"part":"PART 02 · 경기력·데이터","title":"골프 스윙 중 근활성(EMG)",
    ...
    "findings":[
      ...
      "<b>이두·삼두·삼각근은 어느 국면에서도 상위 2위 안에 들지 못했다</b> — 팔의 굵은 근육 의존도는 낮다.",
 ...
 17:{"part":"PART 02 · 경기력·데이터","title":"엘리트 골프: 결과·기술·신체의 관계",
    ...
    "findings":[
      ...
      "높은 클럽헤드 스피드는 백스윙 정점의 <b>큰 척추 회전+어깨뼈(견갑골) 전인(내밈)</b>, 높은 지면반력·토크와 연관.",
...
<p class="note">%BW = 체중 대비 최대토크. 핸디캡이 낮은(잘 치는) 군일수록 코어 근력과 거리가 높다(p=0.001). (출처: Sell et al. 2007)</p>
 ...
 20:{"part":"PART 02 · 경기력·데이터","title":"트레이닝을 통한 부상 예방·경기력 향상",
    ...
    "findings":[
      "<b>요통(low back pain)</b>이 아마추어·프로 공통의 주된 골프 관련 질환 — 요추의 압박·전단·회전·측굴 힘이 원인.",
...
<body><div class="wrap">
  ...
  <header class="hero">
    ...
    <p>비거리·정확성·퍼팅·부상예방까지 — 영향력 있는 논문 18편을 <b>인스타그램 카드</b>로 정리했습니다. 카드를 누르면 <b>스와이프 카드 세트</b>(표지·발견·결론)가 열려요. 더 깊게는 근거 자료집(V2)·논문 딥다이브(V3), 그리고 최신 연구(V4)로 이어집니다.</p>
    {imgspot}
  </header>
  <section class="sec">
